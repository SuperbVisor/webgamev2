...
# Images ----------------------------------------------------- #
tileset_images = load_tileset('Game3/data/images/')
e.set_global_colorkey((0, 0, 0))
e.load_animations('Game3/data/images/entities/')
e.load_particle_images('Game3/data/images/particles/')

def load_img(name):
    img = pygame.image.load('Game3/data/images/' + name + '.png').convert()
...
# Sound ------------------------------------------------------ #
jump_s = pygame.mixer.Sound('Game3/data/sfx/jump.wav')
shoot_s = pygame.mixer.Sound('Game3/data/sfx/shoot.wav')
turret_shoot_s = pygame.mixer.Sound('Game3/data/sfx/turret_shoot.wav')
point_s = pygame.mixer.Sound('Game3/data/sfx/point.wav')
explosion_s = pygame.mixer.Sound('Game3/data/sfx/explosion.wav')
death_s = pygame.mixer.Sound('Game3/data/sfx/death.wav')
...
font = text.generate_font('Game3/data/font/small_font.png',font_dat,5,8,(255, 255, 255))
...
def load_level(number):
    f = open('Game3/data/levels/level_' + str(number) + '.txt', 'r')
    dat = f.read()
    f.close()
...
pygame.mixer.music.load('Game3/data/music.wav')
